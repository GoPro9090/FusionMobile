...
import 'package:fusion/screens/Programme_Curriculum/TimeTable/show_time_table.dart';
import 'package:fusion/screens/Programme_Curriculum/TimeTable/time_table.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/programme_curriculam_home/timetable',
      routes: {
        // testing routes
        '/': (context) => ProgrammeCurriculumHome(),
        '/programme_curriculam_home/show_timetable': (context) =>
            ShowTimeTable(),
        // end
        ...
        '/programme_curriculam_home/timetable': (context) => TimeTable(),
